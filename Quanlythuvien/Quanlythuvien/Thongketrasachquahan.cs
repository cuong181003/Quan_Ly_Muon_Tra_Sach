...
{
    public partial class Thongketrasachquahan : Form
    {         
        Connection_SQL connection = new Connection_SQL();
        string maNV;
        public Thongketrasachquahan(string maNV)
        {
        ...
        {
            DataTable dtThongKe = connection.LaySachQuaHan();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Connection_SQL connection = new Connection_SQL();
                DataTable result = connection.LaySachQuaHan(maPM, tenSach, hoTenDG);
                ...
                {
                    MessageBox.Show("Không tìm thấy sách quá hạn với các thông tin đã nhập.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("Lỗi khi tìm kiếm sách quá hạn: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void ExportToExcel(DataGridView dataGridView, string luu, string tenNV)
        {
            try
            {
                ...
                string TitleBaocao = "Thống kê độc giả mượn sách quá hạn";
        ...
        private void btn_boqua_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "ThongKeSachQuaHan.xlsx";
