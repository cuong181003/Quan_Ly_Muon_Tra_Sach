...
{
    public partial class Thongkesachthatlac : Form
    {          
        Connection_SQL connection = new Connection_SQL();
        string maNV;
        public Thongkesachthatlac(string maNV)
        {
            InitializeComponent();
            HienThiThongKe();
            this.maNV = maNV;
        ...
        {
            DataTable dtThongKe = connection.LaySachBiThatLac();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Connection_SQL connection = new Connection_SQL();
                DataTable result = connection.LaySachBiThatLac(maSach, tenSach);
                ...
                {
                    MessageBox.Show("Không tìm thấy sách bị thất lạc với các thông tin đã nhập.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("Lỗi khi tìm kiếm sách bị thất lạc: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void ExportToExcel(DataGridView dataGridView, string luu, string tenNV)
        {
            try
            {
                ...
                string TitleBaocao = "Thống kê sách bị thất lạc";
        ...
        private void btn_boqua_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "ThongKeSachBiThatLac.xlsx";
